...
public class TotalSumFragment extends Fragment implements iCardConstant {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.total_sum_layout, container, false);
		// 현재 달 구하기
	...
	private void setLayout() {
		...
		LinearLayout kb = (LinearLayout) rootView.findViewById(R.id.kb_label);
		if (sum > 0) {
			TextView kbSum = (TextView)rootView.findViewById(R.id.kb_sum);
		...
		if (sum > 0) {
			LinearLayout lotte = (LinearLayout)rootView.findViewById(R.id.lotte_label);
			TextView lotteSum = (TextView)rootView.findViewById(R.id.lotte_sum);
		...
		if (sum > 0) {
			LinearLayout hd = (LinearLayout)rootView.findViewById(R.id.hd_label);
			TextView hdSum = (TextView)rootView.findViewById(R.id.hd_sum);
		...
		if (sum > 0) {
			LinearLayout city = (LinearLayout)rootView.findViewById(R.id.city_label);
			TextView citySum = (TextView)rootView.findViewById(R.id.city_sum);
		...
		if (sum > 0) {
			LinearLayout bc = (LinearLayout)rootView.findViewById(R.id.bc_label);
			TextView bcSum = (TextView)rootView.findViewById(R.id.bc_sum);
			bcSum.setText("+   "
		...
		if (sum > 0) {
			LinearLayout hana = (LinearLayout)rootView.findViewById(R.id.hana_sk_label);
			TextView hanaSum = (TextView)rootView.findViewById(R.id.hana_sum);
		...
		if (sum > 0) {
			LinearLayout hana = (LinearLayout)rootView.findViewById(R.id.sh_label);
			TextView hanaSum = (TextView)rootView.findViewById(R.id.sh_sum);
			hanaSum.setText(currencyFormatter.format(sum).replace(".00", "")
					+ "원");
			hana.setVisibility(View.VISIBLE);
			totalPrice += sum;
		...
		TextView total = (TextView)rootView.findViewById(R.id.total_sum);
		total.setText(currencyFormatter.format(totalPrice).replace(".00", "")
				+ "원");
		TextView count = (TextView)rootView.findViewById(R.id.total_count);
